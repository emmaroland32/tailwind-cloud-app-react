  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[5%] md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 round-xl text-center shadow-xl">
          <p>Data Services</p>
